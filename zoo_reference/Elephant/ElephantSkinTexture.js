...
/**
 * Create a procedural elephant skin CanvasTexture.
 *
 ...
 * of final shading is done in ElephantSkinNode.js using TSL.
 *
...
export function createElephantSkinCanvasTexture(options = {}) {
  ...
  for (let layer = 0; layer < wrinkleLayers; layer++) {
    ...
    for (let i = 0; i < strokeCount; i++) {
      ...
      // roughly how wrinkles on an elephant flank tend to flow.
...
/**
 * Singleton instance – most elephants will happily share one skin texture.
 */
